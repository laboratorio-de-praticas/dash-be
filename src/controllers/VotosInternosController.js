...
import VotosInternosService from '../services/VotosInternosService.js';
class VotosInternosController {
  // /v1/votos/interno/logs/id_evento/:id_evento
  async findLogVotosInternosByEventoId(req, res, next) {
    try {
      ...
      const response =
        await VotosInternosService.findLogDeVotosByEventoId(idEvento);
...
export default new VotosInternosController();
